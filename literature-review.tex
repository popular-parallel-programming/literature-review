...
Our analysis shows that there are broad possibilities to combine spreadsheet programming with array programming technology to implement implicit parallelization of operations over explicit and implicit arrays. Spreadsheet computations are of a repetitive nature~\cite{1173080, Benfield:2009:FFD:1668113.1668121} and therefore lend themselves to array programming optimizations.
