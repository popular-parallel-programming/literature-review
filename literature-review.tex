...
model of computation. Again, abstraction and programming paradigms cannot simply \todo{Extend!}
...
The system analyzes spreadsheets to infer their logic and to
(subsequently) separate it from data. This allows users to build
spreadsheets in a familiar manner. \todo{Extend!}
...
FMD~\cite{Benfield:2009:FFD:1668113.1668121} exposes objects to
spreadsheet users.
...
Our research questions are listed in the following: \todo{Move to
  introduction.}
