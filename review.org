...
** Arvind et al., 1989: I-Structures: Data Structures for Parallel Computing :data structures:
...
** Fluet et al., 2008: A Scheduling Framework for General-Purpose Languages :scheduling:functional:nested parallelism:
...
** Henriksen & Oancea, 2013: A T2 Graph-Reduction Approach to Fusion :fusion:inference rules:
...
** Knobe & Sarkar, 1998: Array SSA Form and its Use in Parallelization :loops:data flow:data dependence:
...
** Lowney, 1981: Carrier Arrays: An Idiom-Preserving Extension to APL :apl:data structures:
...
** Maydan et al., 1993: Array Data-Flow Analysis and its Use in Array Privatization :data flow:loops:data dependence:
...
** Tang et al., 1990: Compiler Techniques for Data Synchronization in Nested Parallel Loops :loop:data dependence:
...
** Ureche et al., 2012: StagedSAC: A Case Study in Performance-Oriented DSL Development :sac:shape inference:
...
just-in-time.
** Walinsky and Banerjee, 1990: A Functional Programming Language for Massively Parallel Computers :remap:functional:inference rules:
...
** Keller at el., 2010: Regular, Shape-Polymorphic Arrays :data structures:dph:functional:
...
** Lippmeier et al., 2012: Work-Efficient Higher Order Vectorization :flattening:nested data parallelism:dph:functional:
...
** Keller et al., 2012: Vectorization Avoidance :flattening:nested data parallelism:dph:fusion:
...
** Blelloch & Greiner, 1996: A Provable Time and Space Efficient Implementation of NESL :nesl:nested data parallelism:flattening:
...
cost.
** Hall, 1994: Using Hindley-Milner Type Inference to Optimize List Representation :data structures:functional:
...
programs.
** O'Donnel, 1988: Architectures for declarative programming languages :data structures:functional:
Constant-time, functional array implementation. Lookup and update are
of constant time \cite{47507}.
** Sastry & Clinger, 1994: Parallel Destructive Updating in Strict Functional Languages :destructive updates:data flow:functional:
...
** Stucki et al., 2015: RRB Vector: A Practical General Purpose Immutable Sequence :data structures:functional:
...
** Ching, 1990: Automatic Parallelization of APL-style Programs :apl:fusion:scheduling:
...
** Shafarenko, 1994: RETRAN                            :declarative:fortran:
...
** Collins et al., 2014: NOVA                  :declarative:functional:nesl:
...
** Lippmeier et al., 2012: Guiding Parallel Array Fusion :dph:fusion:functional:
...
** Grelck, 2007: Coordinating Data-Parallel SAC                    :dsl:sac:
Declarative streams in SAC. Explicit coordination of parallel
processing in a DSL inside SAC \cite{4228136}.
** Bernecky & Scholz, 2015: Abstract Expressionism for Parallel Performance :functional:sac:
...
** Bergstrom et al., 2010: Lazy Tree Splitting       :functional:scheduling:
...
** Anderson & Hudak, 1990: Compilation of Haskell Array Comprehensions for Scientific Computing :fusion:
...
use arrays.
** Chakravarty & Keller, 2001: Functional Array Fusion   :fusion:flattening:
...
\cite{Chakravarty:2001:FAF:507635.507661}.
** Hwang et al., 1995: An Array Operation Synthesis Scheme to Optimize Fortran 90 Programs :fusion:remap:fortran:
...
** Henriksen & Oancea, 2014: Bounds Checking: An Instance of Hybrid Analysis :loops:
...
** Perrott, 1979: A Language for Array and Vector Processors :pascal:
...
** Sinkarovs & Scholz, 2013: Semantics-Preserving Data Layout Transformations for Improved Vectorization :remap:declarative:
...
** Deitz et al., 2003: The Design and Implementation of a Parallel Array Operator for Arbitrary Data Remapping :remap:functional:zpl:
...
** Grelck & Scholz, 2007: SAC: Off-the-shelf Support for Data-Parallelism on Multicores :sac:functional:scheduling:
